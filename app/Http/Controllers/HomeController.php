...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $workcompany_table = InternshipCompany::where('featured','Yes')->get();
        $internshipcompany_table = InternshipCompany::where('featured','Yes')->get();
        
        return view('welcome', compact('perma_event', 'testimonial' , 'promo', 'featuredimage_home','events_table','internshipcompany_table', 'programs', 'workcompany_table', 'testimonials','counter'));
    }
