        ...
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-3">
                    ...
                    <img src="<?php echo e(URL::asset('image/uploaded_workcompany_image')); ?>/<?php echo e($company->image); ?>" class="img img-responsive img-rounded header" alt="Company Banner">
                </div>
                <div class="col-xs-12 col-md-3">
                    <label>Qualifications:</label>
                    <?php $__currentLoopData = $company->work_qualifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qualification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 ...
                 <div class="col-xs-12 col-md-3">
                    ...
                    <?php $__currentLoopData = $company->work_opportunity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opportunity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
