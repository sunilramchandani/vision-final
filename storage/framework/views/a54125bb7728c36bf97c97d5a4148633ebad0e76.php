                    ...
                    <tbody>
                        <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                <img height="150px" width "150px" src="<?php echo e(URL::asset('image/uploaded_promo_image')); ?>/<?php echo e($program->image_promo); ?>"
                                    alt="Image Error" />
                                </td>
                                <td><?php echo e($program->image_promo); ?></td>
                                <td><?php echo e($program->validity); ?></td>
                                <td>
                                    <a
