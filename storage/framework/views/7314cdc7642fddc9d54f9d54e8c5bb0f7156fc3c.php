...
<form action="<?php echo e(route('contactus.store')); ?>" method="post" role="form">
        ...
        <div class = "country-city-offices row">
            ...
            <div class = "col-xs-5" id="map-1">
                <div class =  "col-xs-12">
                    <div class = "map">
                        <img src="<?php echo e(URL::asset('image/manila.png')); ?>" class="img img-responsive" alt="Location Map">
                    </div>
                </div>
            </div>
            <div class = "col-xs-5" id="map-2">
                <div class =  "col-xs-12">
                    <div class = "map">
                        <img src="<?php echo e(URL::asset('image/cubao.png')); ?>" class="img img-responsive" alt="Location Map">
                    </div>
                </div>
            </div>
            <div class = "col-xs-5" id="map-3">
                <div class =  "col-xs-12">
                    <div class = "map">
                        <img src="<?php echo e(URL::asset('image/baguio.png')); ?>" class="img img-responsive" alt="Location Map">
                    </div>
                </div>
            </div>                                                                                                                      
        </div>
