...
<section class="content-header">
    <h1 class="page-header">
        <div class="row">
            ...
            <div class="col-xs-2">
            <a href="<?php echo e(route('workcompany.list')); ?>"><button class="btn"><i class="fa fa-arrow-left" style="color:black"> &nbsp; Go Back</i></button></a>
            </div>
        </div>
    </h1>
</section>
                ...
                <tbody>
                    <?php $__currentLoopData = $company; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single_company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <td>
                            ...
                            <a href="<?php echo e(route('workcompany.restoretrash', $single_company->id)); ?>" class="btn btn-info">
                                Restore
                            </a>
