            ...
            <div class = "row form-group">
        		...
        		<div class = "col-md-7 col-xs-12">
	                <select class = "form-control" name="current_city" id="">
                        <option value="" disabled selected>Select</option>
                       <?php $__currentLoopData = $city_table; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    var haddress = <?php echo json_encode($work_addresses->toArray()); ?>;
  ...
  var university = <?php echo json_encode($university_table->toArray()); ?>;
  ...
  var degree = <?php echo json_encode($degree_table->toArray()); ?>;
  var degree_list = [];
