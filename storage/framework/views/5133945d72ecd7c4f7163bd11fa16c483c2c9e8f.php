        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class = "col-xs-4">
                ...
                <p> <a href = "<?php echo e($about->about_twitter); ?>"><i class="fa fa-twitter-square"></i></a>  | <a href = "<?php echo e($about->about_linkedin); ?>"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a>  </p>
          </div>
                                ...
                                <div class = "col-xs-6 col-md-3 show-side"> 
                                    ...
                                    <div class = "col-xs-12">
                                        ...
                                        <div class = "hidden-md hidden-lg hidden-xl">
                                            ...
                                            <p class = "position-hidden"> <a href = "<?php echo e($about->about_twitter); ?>"><i class="fa fa-twitter-square"></i></a>  | <a href = "<?php echo e($about->about_linkedin); ?>"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a> </p>
                                        </div>
