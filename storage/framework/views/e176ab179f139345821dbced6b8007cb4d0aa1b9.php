...
<div class = "col-xs-12 company-whole">
    ...
    <img src="<?php echo e(URL::asset('image/uploaded_company_image/'.$company->image)); ?>" class="img img-responsive img-map" alt="Company Banner" height ="100">
        ...
        <?php $__currentLoopData = $internshipCompany_table; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class = "row stip-hous">
                ...
                <div class = "col-xs-6">
                    ...
                    <p>$<?php echo e($company->stipend); ?> - $<?php echo e($company->stipend_maximum); ?>  / Month</p>
                </div>
            </div>
