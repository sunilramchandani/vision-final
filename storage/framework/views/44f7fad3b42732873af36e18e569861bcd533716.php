            ...
            <form action="<?php echo e($action); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class = "col-md-4 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="latitude" name="latitude" value="<?php echo e(isset($company) ? $company->latitude : ''); ?>" placeholder="30.201320">
                    </div>
                </div>
                ...
                <div class = "col-md-4 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="longtitude" name="longtitude" value="<?php echo e(isset($company) ? $company->longtitude : ''); ?>" placeholder="30.201320">
                    </div>
                </div>
                <div class = "col-md-4 col-xs-12">
                    <div class="form-group">
