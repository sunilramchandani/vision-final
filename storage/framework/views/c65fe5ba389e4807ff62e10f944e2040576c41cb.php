...
<section class="content page-opportunities">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <a href="#" class="pop">
                <div class="img-wrap">
                    <a href="<?php echo e(route ('mainblogimage.delete', $image_preview->id)); ?>" onclick="return ConfirmDelete();">
                        <span class="close">&times;</span>
                    </a>

                    <img height="200px" width="200px" src="<?php echo e(URL::asset('image/uploaded_main_blog_image')); ?>/<?php echo e($image_preview->image_name); ?>"
    ...
    <form action="<?php echo e(route('mainblogimage.save', $blog->id)); ?>" method="post" role="form" enctype="multipart/form-data">
