...
<div class="col-xs-12">
  <div class="carousel slide2" id="myCarousel">
    <div class="carousel-inner">
        ...
        <div class="item">
        <?php endif; ?>
        <div class="col-xs-3"><a href="#"><img src="<?php echo e(URL::asset('image/uploaded_aboutus_image')); ?>/<?php echo e($about->about_image); ?>" class="img img-responsive employee" alt="Company Banner"/></a></div>
      </div>
