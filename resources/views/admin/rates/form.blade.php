                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            <label for="company_website">
                                @if($rate->program == "Skilled")
                                    Partner or Spouse
                                @else
                                    Reservation
                                @endif   
                            </label>
                            <input type="number" min="0" class="form-control" id="reservation" name="reservation" value="{{ isset($rate) ? $rate->reservation : '' }}" placeholder="reservation">
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control" id="duration" name="duration" value="{{ isset($rate) ? $rate->duration : '' }}" placeholder="duration">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control" id="first" name="first" value="{{ isset($rate) ? $rate->first : '' }}" placeholder="first">
                        </div>
                    ...
                    <div class="col-xs-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control" id="second" name="second" value="{{ isset($rate) ? $rate->second : '' }}" placeholder="second">
                        </div>
                    ...
                    <div class="col-xs-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control" id="third" name="third" value="{{ isset($rate) ? $rate->third : '' }}" placeholder="third">
                        </div> 
                    </div>
                    ...
                    <div class="col-xs-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control" id="visa" name="visa" value="{{ isset($rate) ? $rate->visa : '' }}" placeholder="visa">
                        </div>
